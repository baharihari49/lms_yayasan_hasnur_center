                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="">
                        ...
                        <select name="kursus_id" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <option value="{{$itemKursus->id}}">{{$itemKursus->judul}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="sm:col-span-2">
                        <label for="link_materi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Materi</label>
                        <input type="text" name="link_materi" id="link_materi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Link materi" required="">
                    </div>
                    <div class="sm:col-span-2">
